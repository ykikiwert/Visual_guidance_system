...
class SpatialCalculatorSR(SpatialCalculatorBase):
    def __init__(
        self,
    ...
    def create_pipeline(self) -> dai.Pipeline:
        ...
        # Properties
        left.setResolution(dai.ColorCameraProperties.SensorResolution.THE_720_P)
        # left.setResolution(dai.ColorCameraProperties.SensorResolution.THE_1200_P)
        # left.setIspScale(1, 3)
        left.setFps(30)
        right.setResolution(dai.ColorCameraProperties.SensorResolution.THE_720_P)
        ...
        stereo.syncedLeft.link(sync_node.inputs["color"])
...
if __name__ == "__main__":
    with SpatialCalculatorSR(device_id=None, roi_length=1, spatial_config=spatial_config) as spatial_calculator:
